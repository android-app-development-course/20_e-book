...
public class CommonUtil {
    ...
    static float convertDpToPixel(final Context context, final float dp) {
     ...
     * @return
     */
    static int sp2px(Context context, float spVal)
    {
    ...
    static String subString(String text, int num){
        String content = "";
        if (text.length() > num){
