...
import com.example.searcher.searchengine.FileItem;
import com.example.searcher.searchengine.SearchEngine;
...
public class FileSearcherActivity extends AppCompatActivity {
    ...
    private void initializeSearchEngine(){
        ...
        searchEngine.setCallback(new SearchEngine.SearchEngineCallback() {
            ...
            public void onFinish() {
                ...
                toolbar.setSubtitle(getString(com.example.searcher.R.string.file_searcher_searching_completed));
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.example.searcher.R.menu.file_searcher_activity_menu,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == com.example.searcher.R.id.file_searcher_menu_select_all && !searchEngine.isSearching()){
