...
public class FileSearcherAdapter extends RecyclerView.Adapter<FileSearcherAdapter.FileSearcherVH> {
    ...
    FileSearcherAdapter(Context context, @NonNull SearchEngine searchEngine){
    ...
    void addItem(List<FileItem> item){
        items.addAll(item);
    ...
    void setOnItemSelectCallback(OnItemSelectCallback callback){
    ...
    class FileSearcherVH extends RecyclerView.ViewHolder{
        ...
        CheckBox checkBox;
        FileSearcherVH(final View itemView) {
            super(itemView);
